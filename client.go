...
func NewClient(apiKey string) *Client {
	return NewClientWith(JCDecauxAPIURL, UserAgent, apiKey, nil)
}

func NewClientWith(baseURL string, UserAgent string, apiKey string, httpClient *http.Client) *Client {
	client, _ := sawyer.NewFromString(baseURL, httpClient)
	return &Client{Client: client, UserAgent: UserAgent, ApiKey: apiKey}
}
